...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newItemDeListedEvent = createItemDeListedEvent(
      seller,
      nftAddress,
      tokenId
    )
    handleItemDeListed(newItemDeListedEvent)
  })
  ...
  test("ItemDeListed created and stored", () => {
    assert.entityCount("ItemDeListed", 1)
